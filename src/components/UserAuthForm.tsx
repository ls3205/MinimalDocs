...
const UserAuthForm: React.FC<UserAuthFormProps> = ({ className, ...props }) => {
	...
	return (
		...
		>
			<button
				className="flex flex-row w-auto h-full m-4 mb-2 p-3 justify-center bg-black rounded-md hover:rounded-xl transition-all duration-300"
			...
			<button
				className="flex flex-row w-auto h-full m-4 mt-2 p-3 justify-center bg-[#5865F2] rounded-md hover:rounded-xl transition-all duration-300"
