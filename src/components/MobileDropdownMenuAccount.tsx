...
const MobileDropdownMenuAccount: React.FC<DropdownMenuAccountProps> = ({ user }) => {
    const { theme } = useTheme();
    const [isLoading, setIsLoading] = useState<boolean>(false)

    return (
        <DropdownMenu>
            <DropdownMenuTrigger className="w-full h-full footer-button">
                <Avatar className="relative w-14 h-14 left-1/2 -translate-x-1/2">
                    {user.image ? (
...
export default MobileDropdownMenuAccount;
