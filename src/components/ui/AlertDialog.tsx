...
const AlertDialogHeader = ({
  ...
  <div
    className={cn(
      "flex flex-col space-y-2 sm:text-center text-left",
      className
    )}
    {...props}
  />
...
const AlertDialogFooter = ({
  ...
  <div
    className={cn(
      "flex sm:flex-col-reverse flex-row justify-end space-x-2",
      className
    )}
    {...props}
  />
