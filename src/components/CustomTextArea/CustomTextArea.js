        ...
        >
            <ul className="flex flex-col w-full h-full">
                ...
                <li className="w-full h-full">
                    <textarea
                        className={`relative border-b-[1px] border-accent outline-none w-[95%] h-[99%] left-[2.5%] top-[1%] text-[20px] resize-none pr-2.5 bg-bg text-text caret-subtext placeholder-subtext sm:border-none`}
                        id="textfield"
