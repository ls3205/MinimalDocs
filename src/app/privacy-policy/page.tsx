...
const page: React.FC<pageProps> = ({}) => {
    return (
        <div className="flex h-auto flex-col items-center overflow-x-hidden">
            {/* <DesktopPrimaryDropdown className="left-5 top-5" /> */}
            <div className="h-auto w-3/5 overflow-x-hidden py-16">
                <Link href="/" className="link mt-6 flex flex-row">
                    <ChevronLeft />
                    Home
                </Link>
                ...
                <ul>
                    ...
                    <li>
                        <p>
                            <strong>Website</strong> refers to MinimalDocs,
                            accessible from{" "}
                            <a
                ...
                <ul>
                    <li>By email: schaumannleon@gmail.com</li>
                </ul>
            </div>
        </div>
    );
